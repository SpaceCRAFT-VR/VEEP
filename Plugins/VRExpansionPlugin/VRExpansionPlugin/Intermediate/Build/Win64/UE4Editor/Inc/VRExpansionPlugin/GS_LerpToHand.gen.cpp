...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UGS_LerpToHand_Statics::NewProp_MaxSpeedForLerp = { UE4CodeGen_Private::EPropertyClass::Float, "MaxSpeedForLerp", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(UGS_LerpToHand, MaxSpeedForLerp), METADATA_PARAMS(Z_Construct_UClass_UGS_LerpToHand_Statics::NewProp_MaxSpeedForLerp_MetaData, ARRAY_COUNT(Z_Construct_UClass_UGS_LerpToHand_Statics::NewProp_MaxSpeedForLerp_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UGS_LerpToHand_Statics::NewProp_MinSpeedForLerp = { UE4CodeGen_Private::EPropertyClass::Float, "MinSpeedForLerp", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(UGS_LerpToHand, MinSpeedForLerp), METADATA_PARAMS(Z_Construct_UClass_UGS_LerpToHand_Statics::NewProp_MinSpeedForLerp_MetaData, ARRAY_COUNT(Z_Construct_UClass_UGS_LerpToHand_Statics::NewProp_MinSpeedForLerp_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UGS_LerpToHand_Statics::NewProp_LerpDuration = { UE4CodeGen_Private::EPropertyClass::Float, "LerpDuration", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(UGS_LerpToHand, LerpDuration), METADATA_PARAMS(Z_Construct_UClass_UGS_LerpToHand_Statics::NewProp_LerpDuration_MetaData, ARRAY_COUNT(Z_Construct_UClass_UGS_LerpToHand_Statics::NewProp_LerpDuration_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UGS_LerpToHand, 3043165960);
